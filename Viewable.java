...
Game getGame(DifficultyEnum level) throws NotFoundException, IOException;
...
String verifyGame(Game game) throws IOException;
...
int[] solveGame(Game game) throws InvalidGame, InterruptedException;
